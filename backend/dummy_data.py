...
def insert_dummy(session):
    ...
    session.execute(insert(models.SoundClass).values(name = "Speech", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Whispering", color = "lightblue"))
    session.execute(insert(models.SoundClass).values(name = "Shout", color = "green"))
    session.execute(insert(models.SoundClass).values(name = "Yell", color = "red"))
    session.execute(insert(models.SoundClass).values(name = "Screaming", color = "pink"))
    session.execute(insert(models.SoundClass).values(name = "Laughter", color = "purple"))
    session.execute(insert(models.SoundClass).values(name = "Crying", color = "orange"))
    session.execute(insert(models.SoundClass).values(name = "Cough", color = "cyan"))
    session.execute(insert(models.SoundClass).values(name = "Crack", color = "sienna"))
    session.execute(insert(models.SoundClass).values(name = "Slap", color = "lightgreen"))
    session.execute(insert(models.SoundClass).values(name = "Breaking", color = "gray"))
    session.execute(insert(models.SoundClass).values(name = "Crushing", color = "teal"))
    session.execute(insert(models.SoundClass).values(name = "Music", color = "linen"))
    session.execute(insert(models.SoundClass).values(name = "Television", color = "lightblue"))
    session.execute(insert(models.SoundClass).values(name = "Alarm", color = "lightyellow"))
    session.execute(insert(models.SoundClass).values(name = "Telephone", color = "beige"))
    session.execute(insert(models.SoundClass).values(name = "Ringtone", color = "coral"))
    session.execute(insert(models.SoundClass).values(name = "Alarm clock", color = "darkgreen"))
    session.execute(insert(models.SoundClass).values(name = "Radio", color = "mediumturquoise"))
    session.execute(insert(models.SoundClass).values(name = "Vehicle", color = "slategrey"))
    session.execute(insert(models.SoundClass).values(name = "Car alarm", color = "olive"))
    session.execute(insert(models.SoundClass).values(name = "Traffic noise", color = "ivory"))
    session.execute(insert(models.SoundClass).values(name = "Explosion", color = "navajowhite"))
    session.execute(insert(models.SoundClass).values(name = "Gunshot", color = "lavender"))
    session.execute(insert(models.SoundClass).values(name = "Boom", color = "palevioletred"))
    ...
    ### COLOR TEST, DELETE LATER ###
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Whispering", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Yell", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Screaming", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Laughter", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Crying", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Cough", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Crack", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Slap", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Breaking", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Crushing", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Music", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Television", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Alarm", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Telephone", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Ringtone", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Alarm clock", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Radio", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Vehicle", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Car alarm", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Traffic noise", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Explosion", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Gunshot", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Boom", sound_interval_id = 1))
    session.execute(insert(models.Sound).values(trust_value = 0.6, sound_class = "Door", sound_interval_id = 1))
    #########################
