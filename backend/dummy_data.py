...
def insert_dummy(session):
    ...
    session.execute(insert(models.SoundClass).values(name = "Whispering", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Shout", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Yell", color = "red"))
    session.execute(insert(models.SoundClass).values(name = "Screaming", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Laughter", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Crying", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Cough", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Crack", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Slap", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Breaking", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Crushing", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Music", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Television", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Alarm", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Telephone", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Ringtone", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Alarm clock", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Radio", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Vehicle", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Car alarm", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Traffic noise", color = "yellow"))
    session.execute(insert(models.SoundClass).values(name = "Explosion", color = "yellow"))
