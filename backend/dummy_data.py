...
def insert_dummy(session):
    ...
    session.execute(insert(models.SoundClass).values(name = "Whispering", color = "blue"))
    ...
    session.execute(insert(models.SoundClass).values(name = "Crack", color = "black"))
    session.execute(insert(models.SoundClass).values(name = "Slap", color = "light-green"))
    session.execute(insert(models.SoundClass).values(name = "Breaking", color = "gray"))
    session.execute(insert(models.SoundClass).values(name = "Crushing", color = "light-gray"))
    session.execute(insert(models.SoundClass).values(name = "Music", color = "light-brown"))
    session.execute(insert(models.SoundClass).values(name = "Television", color = "light-blue"))
    session.execute(insert(models.SoundClass).values(name = "Alarm", color = "light-yellow"))
    ...
    session.execute(insert(models.SoundClass).values(name = "Alarm clock", color = "dark-green"))
    session.execute(insert(models.SoundClass).values(name = "Radio", color = "dark-blue"))
    session.execute(insert(models.SoundClass).values(name = "Vehicle", color = "dark-red"))
    ...
    session.execute(insert(models.SoundClass).values(name = "Explosion", color = "indigo"))
    session.execute(insert(models.SoundClass).values(name = "Gunshot", color = "lavender"))
    session.execute(insert(models.SoundClass).values(name = "Boom", color = "maroon"))
