...
def insert_dummy(session):
    ...
    session.execute(insert(models.SoundClass).values(name = "EXPLOSION", color = "#870000"))
    session.execute(insert(models.SoundClass).values(name = "GUNSHOT", color = "#ff0000"))
    session.execute(insert(models.SoundClass).values(name = "BOOM", color = "#ff0037"))
    session.execute(insert(models.SoundClass).values(name = "SCREMING", color = "#ff006f"))
    session.execute(insert(models.SoundClass).values(name = "YELL", color = "#ff00dd"))
    session.execute(insert(models.SoundClass).values(name = "SHOUT", color = "#ea00ff"))
    session.execute(insert(models.SoundClass).values(name = "SLAP", color = "#b300ff"))
    session.execute(insert(models.SoundClass).values(name = "CRYING", color = "#7b00ff"))
    session.execute(insert(models.SoundClass).values(name = "BREAKING", color = "#4400ff"))
    session.execute(insert(models.SoundClass).values(name = "CRUSHING", color = "#0d00ff"))
    session.execute(insert(models.SoundClass).values(name = "CRACK", color = "#002bff"))
    session.execute(insert(models.SoundClass).values(name = "LAUGHTER", color = "#0062ff"))
    session.execute(insert(models.SoundClass).values(name = "SPEECH", color = "#0099ff"))
    session.execute(insert(models.SoundClass).values(name = "WHISPERING", color = "#00d0ff"))
    session.execute(insert(models.SoundClass).values(name = "ALARM", color = "#00fff7"))
    session.execute(insert(models.SoundClass).values(name = "CAR ALARM", color = "#00ffbf"))
    session.execute(insert(models.SoundClass).values(name = "ALARM CLOCK", color = "#00ff88"))
    session.execute(insert(models.SoundClass).values(name = "COUGH", color = "#00ff19"))
    session.execute(insert(models.SoundClass).values(name = "MUSIC", color = "#55ff00"))
    session.execute(insert(models.SoundClass).values(name = "TELEPHONE", color = "#c3ff00"))
    session.execute(insert(models.SoundClass).values(name = "RINGTONE", color = "#fbff00"))
    session.execute(insert(models.SoundClass).values(name = "RADIO", color = "#ffcc00"))
    session.execute(insert(models.SoundClass).values(name = "TELEVISION", color = "#ff9500"))
    session.execute(insert(models.SoundClass).values(name = "VEHICLE", color = "#ff5e00"))
    session.execute(insert(models.SoundClass).values(name = "TRAFFIC NOICE", color = "#ff2f00"))
    session.execute(insert(models.SoundClass).values(name = "DOOR", color = "#ff1500"))
